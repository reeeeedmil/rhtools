pub fn show_binary(input: Option<u32>) {
    let input = match input {
        Some(num) => num,
        None => {println!("number is none"); std::process::exit(0);}
    };
...
pub fn show_hexadecimal(input: Option<u32>) {
    let input = match input {
        Some(num) => num,
        None => {println!("number is none"); std::process::exit(0);}
    };
...
pub fn show_octal(input: Option<u32>) {
    let input = match input {
        Some(num) => num,
        None => {println!("number is none"); std::process::exit(0);}
    };
